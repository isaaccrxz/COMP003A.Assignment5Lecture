...
namespace COMP003A.Assignment5
{
    internal class Program
    {
        ...
        /* XML L comments are prefixed with three forward slashes '///' 
         ...
         *
         *there are other tags in https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/xmldoc/recomm
           ended-tags
         */
        
        // NOTE: Method definitions are programmed inside the class {  } code block, not the inside Main() {  }
        /// <summary>
        ...
        /// </summary>
        /// <param name="inputAge">String inout</param>
        ...
        /// <param name="num1">Decimal input</param>
        /// <param name="num2">Decimal input</param>
        /// <returns>Remainer after dividing two decimal inputs</returns>
